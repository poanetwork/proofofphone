...
4 verbose stack Error: missing script: browserify
...
5 verbose cwd /Users/viktorbaranov/Documents/HintsProjects/proofofaddressHeroku/node_modules
6 error Darwin 15.4.0
7 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "browserify"
8 error node v5.10.1
9 error npm  v3.8.3
10 error missing script: browserify
